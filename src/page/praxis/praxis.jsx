...
const Praxis = () => {
  return (
    <>
      <Helmet>
        <title>
          Praxis für Klassische Homöopathie in Eberbach | Andreas Dinkelacker
        </title>
        <meta
          name="description"
          content="Praxis für Klassische Homöopathie in Eberbach. Andreas Dinkelacker begleitet Menschen mit chronischen und akuten Beschwerden ganzheitlich und individuell. Heilpraktiker, Yogalehrer und Beratung zu Gesundheit, Entspannung und Wohlbefinden."
        />
      </Helmet>
      <div className="praxis">
        ...
        <div className="text-container">
          ...
          <p>
            ...
            gründliche Erstaufnahme bei Erwachsenen bedarf gewöhnlich 1-2
            Stunden. Ganz individuell arbeite ich dann eine homöopathische
            Arznei für Ihr Beschwerdebild aus.
          </p>
          ...
          <p>
            ...
            Linderung zu bieten. Im Rahmen regelmäßiger Termine begleite ich
            Ihre Behandlung und passe das Mittel bei Bedarf an, um optimale
          ...
          <p>
            ...
            erfahrene KollegInnen mit jeweiligen Praxisschwerpunkten zu
            empfehlen. Mein Behandlungsziel ist stets, dass Sie als Patient
          ...
          <p>
            Private Kranken- und Zusatzversicherungen übernehmen meist den
            größten Teil der Heilpraktikerleistungen.
          </p>
          <p>
