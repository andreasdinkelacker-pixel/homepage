...
const Qualifikationen = () => {
  return (
    <>
      <Helmet>
        <title>
          Qualifikation & Ausbildung | Andreas Dinkelacker – Heilpraktiker und
          Yogalehrer
        </title>
        <meta
          name="description"
          content="Erfahren Sie mehr über die Qualifikationen von Andreas Dinkelacker. Staatlich zugelassener Heilpraktiker seit 2004, Yogalehrer, Ausbildung in klassischer Homöopathie, Naturheilkunde, Schmerztherapie und Präventionskursen."
        />
      </Helmet>
      <div className="qualifikationen">
        <section className="vita">
          ...
          <ul>
            ...
            <li>
              Zertifizierter Kursleiter entsprechend der
